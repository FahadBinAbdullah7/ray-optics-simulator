...
const SimulatorPage = () => {
  ...
  const LENS_MIRROR_TOUR: TourStep[] = [
    ...
    { selector: "#use-case-section", title: t("ব্যবহারের উদাহরণ", "Use Case Examples"), desc: t("এখানে বিভিন্ন বাস্তব ব্যবহারের অ্যানিমেশন দেখা যাবে। যেকোনো কার্ডে ক্লিক করুন।", "Animations of real-world applications appear here. Click any card.") },
    { selector: ".lab-test-btn", title: t("ল্যাব টেস্ট", "Lab Test"), desc: t("৫টি কুইজে অংশ নিয়ে পয়েন্ট অর্জন করুন এবং আপনার বোঝাপড়া যাচাই করুন!", "Join 5 quizzes, earn points and test your understanding!") },
  ];
    ...
    <div className="simulator-page-root">
      <style>{`
        ...
        .main-tabs {
          ...
          border-radius: 16px; padding: 6px; gap: 8px;
